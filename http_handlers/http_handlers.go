/* Taken from the Go Tour (Exercise: HTTP Handlers)
 *
 * Implement the following types and define ServeHTTP methods on them. Register them to handle
 * specific paths in your web server.
 *
 * type String string
 *
 * type Struct struct {
 ...
 *
 * Note: This example won't run through the web-based tour user interface. To try writing web
 * servers you may want to Install Go.
 *
 */
